...
const config = {
    ...
    height: 480,
    parent: 'content',
    scene: [__WEBPACK_IMPORTED_MODULE_1__scenes_preloader__["a" /* Preloader */], __WEBPACK_IMPORTED_MODULE_2__scenes_game__["a" /* Game */]]
};
...
class Game extends __WEBPACK_IMPORTED_MODULE_0_phaser__["Scene"] {
    constructor() {
        super({
            key: 'game'
        });
